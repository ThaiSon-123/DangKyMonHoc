...
- **Soft constraints**:
  - Ưu tiên ca học.
  - Ngày muốn tránh.
  - Giảm tiết trống/gap trong ngày.
...
3. Có thể giải thích được bằng breakdown điểm: ngày, ca học, giáo viên, gap.
...
- Điểm tổng.
- Breakdown: weekday/session/teacher/gap.
...
| Preset | Weekday | Session | Teacher | Gap | Khi dùng |
|---|---:|---:|---:|---:|---|
...
| `COMPACT_FIRST` | 0.15 | 0.15 | 0.15 | 0.55 | Ưu tiên TKB gọn |
...
Gap là số tiết trống giữa hai buổi học liên tiếp trong cùng một ngày.

```text
gap = current.start_period - previous.end_period - 1
s_gap = max(0, 100 - total_gap * 5)
```

Nếu sinh viên tắt `minimize_gaps`, score = 100.
